...
def initialize(gas, particle_volumes, T, P, SS, pH, dry_diameters, Ns):
    ...
    density_i = {'SO4--': 1800, 'NO3-': 1800, 'Cl': 2200, 
                 ...
                 'BC': 1800, 'H2O': 1000, 'IEPOX': 1400,
                 'tetrol': 1400, 'IEPOXOS': 1400, 'dust': 2500}
    ...
    kappa_i = {'SO4--': 0.65, 'NO3-': 0.65, 'Cl': 0.53, 
              ...
              'ARO2': 0.1, 'ALK1': 0.1, 'OLE1': 0.1,
                 ...
                 'BC': 1.0E-5, 'H2O': 0., 'IEPOX': 0.1, 'tetrol': 0.1,
                 'IEPOXOS': 0.1, 'dust': 1.0E-5}
    ...
    for i in range(0, len(dry_diameters)):
        name = 'Dp, ' + str(i+1)
        y0[indexing.getIndex(name, bins)] = np.log(diameters[i])
        name = 'Ddry, ' + str(i+1)
        y0[indexing.getIndex(name, bins)] = np.log(dry_diameters[i])
        name = 'pH, ' + str(i+1)
